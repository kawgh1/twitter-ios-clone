...
class LoginController: UIViewController {
    ...
    private let dontHaveAccountButton: UIButton = {
        ...
        button.addTarget(target, action: #selector(handleShowSignUp), for: .touchUpInside)
        return button
    }()
    ...
    func configureUI() {
        ...
        logoImageView.centerX(inView: view, topAnchor: view.safeAreaLayoutGuide.topAnchor, paddingTop: 16)
